...
import type { BuilderProcessorOptions, Kmore } from '##/lib/kmore.js'
...
export async function pagingPreProcessor(options: BuilderProcessorOptions): Promise<BuilderProcessorOptions> {
...
async function genBuilderForPaging(options: BuilderProcessorOptions): Promise<GenBuilderForPagingRetType> {
