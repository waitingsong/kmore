...
export type TbColListMap = Map<CallerId, TableCols<object>>
...
export interface TablesMapArr<T extends TTables>
  extends Array<Tables<T> | TableCols<T> | TableScopedCols<T>> {
  0: Tables<T>
  1: TableCols<T>
 ...
 */
export type TableCols<T extends TTables> = T extends void
  ? EmptyTbList
